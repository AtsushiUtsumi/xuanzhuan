...
class ApplicationJava(Application):
    ...
    def add_use_case(self, use_case: UseCase):
        ...
        # Serviceクラス
        xz.create_concrete_from_params(f'{xz.__templates_dir__}/add_use_case/Service.java.j2', {'use_case': use_case, 'package': package_root+'.service'}, service_file_name)
        xz.create_concrete_from_params(f'{xz.__templates_dir__}/add_use_case/ServiceCommand.java.j2', {'package': package_root+'.service'}, command_file_name)
        xz.create_concrete_from_params(f'{xz.__templates_dir__}/add_use_case/ServiceTest.java.j2', {'package': package_root+'.service'}, test_file_name)
